...
with open("./Leaf_control_Biological_Replicate_2/quant.sf") as f:
     control_Biological_Replicate_2 = []
     for line in f:
             control_Biological_Replicate_2.append(line.strip("\n"))

with open("./Leaf_control_Biological_Replicate_1/quant.sf") as f:
     control_Biological_Replicate_1 = []
     for line in f:
             control_Biological_Replicate_1.append(line.strip("\n"))

with open("./Leaf_cold27_Biological_Replicate_1/quant.sf") as f:
     cold27_Biological_Replicate_1 = []
     for line in f:
             cold27_Biological_Replicate_1.append(line.strip("\n"))

with open("./Leaf_cold27_Biological_Replicate_2/quant.sf") as f:
